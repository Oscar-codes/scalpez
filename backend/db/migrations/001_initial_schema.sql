...
CREATE TABLE `performance_snapshots` (
  ...
  -- Timing
  `period_start` DATETIME DEFAULT NULL COMMENT 'Inicio del período medido',
  `period_end` DATETIME DEFAULT NULL COMMENT 'Fin del período',
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Particionamiento deshabilitado para compatibilidad con MariaDB/XAMPP
-- (se puede habilitar en MySQL 8.0+ sin FK o usando tablas separadas)
